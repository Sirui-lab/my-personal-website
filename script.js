document.addEventListener('DOMContentLoaded', () => {
    ...
    const sfxCat = new Audio('sfx/cat.wav');
    const sfxPaper = new Audio('sfx/paper.wav');
    const sfxPhone = new Audio('sfx/phone.wav');
    sfxCat.volume = 0.6;
    sfxPaper.volume = 0.7;
    sfxPhone.volume = 0.5;
...
const photoSources = [
    ...
    'photos/09.jpg','photos/10.jpg','photos/11.jpg'
];
const photoCaptions = [
